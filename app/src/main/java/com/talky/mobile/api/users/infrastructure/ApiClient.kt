package com.talky.mobile.api.users.infrastructure
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "com.talky.mobile.api.users.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://api.talky.jho.ovh/users")
        }
    }
}
