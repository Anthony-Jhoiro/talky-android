package com.talky.mobile.api.posts.infrastructure
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "com.talky.mobile.api.posts.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "http://posts-service:8001")
        }
    }
}
